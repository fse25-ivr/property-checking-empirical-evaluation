...
typedef struct {
  uint8_T is_active_c4_model;          /* '<Root>/Debouncer Logic Table' */
  uint8_T is_c4_model;                 /* '<Root>/Debouncer Logic Table' */
  uint8_T temporalCounter_i1;          /* '<Root>/Debouncer Logic Table' */
} DW;
 ...
 *
 * '<Root>' : 'model'
 * '<S1>'   : 'model/Debouncer Logic Table'
 */
