...
{
  printf("%s %s %s %s %s %s %d %s %s %s %d %d %d %d %d ", alarm_on_state_str[rtDW.is_On],
    ...
    rtU.Alarm_active, rtU.M_mode, rtU.W_mode, rtDW.temporalCounter_i1, rtDW.temporalCounter_i2);
